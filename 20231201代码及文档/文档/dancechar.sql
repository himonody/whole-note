...
CREATE TABLE `act_lottery_records` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_cust_act_task` (`mobile`,`act_no`) USING BTREE,
...
CREATE TABLE `customer_info` (
  ...
  `delete_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uqx_mobile` (`mobile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='客户信息';
...
CREATE TABLE `integral_log_info` (
  ...
  `operate_type` tinyint DEFAULT NULL COMMENT '操作类型，0:加积分 1:扣减积分',
  `operate_num` int DEFAULT NULL COMMENT '操作数量',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  `update_date` datetime DEFAULT NULL COMMENT '更新时间',
  `create_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人',
  `update_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '更新人',
  `delete_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `uqx_c_b_b` (`customer_id`,`business_type`,`business_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='积分流水表';

-- ----------------------------
-- Table structure for integral_records
-- ----------------------------
DROP TABLE IF EXISTS `integral_records`;
CREATE TABLE `integral_records` (
  ...
  `delete_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uqx_b_b` (`business_type`,`business_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='积分流水表';
...
CREATE TABLE `WORKER_NODE` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='百度ID生成器表';
