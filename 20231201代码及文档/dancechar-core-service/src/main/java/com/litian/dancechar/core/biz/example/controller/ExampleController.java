...
import com.litian.dancechar.core.biz.item.service.ItemInfoService;
...
public class ExampleController {
    ...
    public RespResult<Void> batchInsertItem(@RequestParam("num")Integer num) {
        itemInfoService.batchInsert(num);
        return RespResult.success();
    }

    @PostMapping("findItemList")
    public RespResult<List<ItemInfoRespDTO>> findItemList() {
        return RespResult.success(itemInfoService.findList(null));
    }

    @PostMapping("getByCache")
    public RespResult<Void> getByCache(@RequestParam("key")String key) {
        itemInfoService.getByCache(key);
        return RespResult.success();
    }
