...
public class SystemUserController {
    ...
    public RespResult<SystemUserRespDTO> findById(@RequestBody SystemUserReqDTO req) {
        return RespResult.success(DCBeanUtil.copyNotNull(new SystemUserRespDTO(), systemUserService.findById(req.getId())));
    }
    ...
    public RespResult<SystemUserRespDTO> getByAccountNo(@RequestBody SystemUserReqDTO req) {
        return RespResult.success(DCBeanUtil.copyNotNull(new SystemUserRespDTO(),
                systemUserService.getByAccountNo(req.getAccountNo())));
    }
